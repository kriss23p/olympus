...
exports.build = series(parallel(clean, htmlInclude, jsCompile, mainJsCompile, importJS, libraryJS, pluginJS, scssCompile, libraryImages, spritesImage, libraryMovs, libraryWsg, libraryFonts)); // 전체 빌드 task
exports.semi = series(parallel(htmlInclude, jsCompile, mainJsCompile, scssCompile, libraryImages, libraryMovs)); // 세미 빌드 task
